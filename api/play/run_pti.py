...
from api.configs import global_config, paths_config
from api.inversion_training.coaches.multi_id_coach import MultiIDCoach
from api.inversion_training.coaches.single_id_coach import SingleIDCoach
...
def run_PTI(run_name='', use_wandb=False, use_multi_id_training=False):
    ...
    embedding_dir_path = paths_config.embedding_base_dir
    os.makedirs(embedding_dir_path, exist_ok=True)

    dataset = ImagesDataset(paths_config.processed_images_dir, transforms.Compose([
        transforms.ToTensor(),
...
if __name__ == '__main__':
    run_PTI(run_name='jenifer', use_wandb=False, use_multi_id_training=False)
